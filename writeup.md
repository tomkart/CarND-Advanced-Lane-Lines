...
I used a combination of color and gradient thresholds to generate a binary image (thresholding steps at Cell 10 in "project.ipynb".  Here's an example of my output for this step.  
